...
2. The hidden directory ".bmad-core" is renamed to ".aios-core" 
...
- [x] Update hidden directory references (AC: 2)
  - [x] Change all ".bmad-core" references to ".aios-core" in installer.js
...
1. `tools/installer/lib/installer.js` - Contains multiple .bmad-core references
...
- Updated all .bmad-core references to .aios-core
...
- Knowledge base files were automatically renamed when .bmad-core was renamed to .aios-core
...
- tools/installer/lib/installer.js (updated .bmad-core to .aios-core, BMad Method to AIOS-FULLSTACK)
...
- docs/core-architecture.md (updated bmad-core paths and agent names)
...
- .aios-core/ (entire directory renamed from .bmad-core/, preserving all contents)
...
- [x] Hidden directory renamed from .bmad-core to .aios-core
