...
**Para que** possa documentar decisões de produto de forma padronizada e rastreável.
...
variables:
  ...
  - name: title
    type: string
    required: true
    prompt: "Título da decisão de produto:"
  - name: status
    type: choice
    required: true
  ...
  - name: stakeholders
    type: array
    required: true
    prompt: "Quem são os stakeholders?"
  - name: context
    type: text
    required: true
    prompt: "Qual é o contexto de produto/negócio?"
  - name: decision
    type: text
    required: true
    prompt: "Qual é a decisão de produto tomada?"
  - name: businessImpact
    type: text
    required: true
    prompt: "Qual é o impacto no negócio?"
  - name: successMetrics
    type: array
    required: true
---
